...
<%
try{
    PreparedStatement pstmt = con.prepareStatement("SELECT * FROM image join detail WHERE image.image_id = detail.image_id and location = (?)", Statement.RETURN_GENERATED_KEYS);
    pstmt.clearParameters();
    pstmt.setString(1, request.getParameter("image_location") );
