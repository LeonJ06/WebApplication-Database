...
<%
try{
    PreparedStatement pstmt = con.prepareStatement("SELECT * from artist Where country=(?)", Statement.RETURN_GENERATED_KEYS);
    pstmt.clearParameters();
    pstmt.setString(1, request.getParameter("artist_country") );
