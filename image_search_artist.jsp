...
<%
try{
    PreparedStatement pstmt = con.prepareStatement("SELECT * FROM image natural join artist WHERE name = (?)", Statement.RETURN_GENERATED_KEYS);
    pstmt.clearParameters();
    pstmt.setString(1, request.getParameter("image_artist") );
