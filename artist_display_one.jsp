...
<%
try{
   PreparedStatement pstmt = con.prepareStatement("SELECT * FROM artist  WHERE artist_id=(?)", Statement.RETURN_GENERATED_KEYS);
   pstmt.clearParameters();
   pstmt.setString(1, request.getParameter("search_artist_id") );
...
%>
<table border =1 align ="center" width ="61.8%">
<%      
